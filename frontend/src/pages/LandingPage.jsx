...
import { ArrowRight, Brain, Activity, ShieldCheck, Pill, Stethoscope, ChevronRight, Star } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-slate-950">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="inline-flex items-center space-x-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-1.5 mb-8 animate-fade-in-up hover:bg-indigo-500/20 transition-colors cursor-pointer">
          ...
          <span className="text-sm font-semibold text-indigo-300">Prescripto AI 2.0 is now live</span>
        ...
        <p className="max-w-2xl text-lg sm:text-xl text-slate-400 mb-10 leading-relaxed font-medium">
          Transform confusing handwritten prescriptions into clear, actionable insights. Cut healthcare costs with generic alternatives, track your chronic conditions, and never miss a dose again.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/5">
            <div>
              ...
              <div className="text-sm font-medium text-slate-400">OCR Accuracy</div>
            </div>
            <div>
              <div className="text-3xl font-black text-white mb-1">10k+</div>
              <div className="text-sm font-medium text-slate-400">Medicines in DB</div>
            </div>
            <div>
              <div className="text-3xl font-black text-white mb-1">~60%</div>
              <div className="text-sm font-medium text-slate-400">Average Savings</div>
            </div>
            <div>
              <div className="text-3xl font-black text-white mb-1">24/7</div>
              <div className="text-sm font-medium text-slate-400">AI Health Assistant</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 w-full">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Everything you need to manage your healthcare.</h2>
          <p className="text-lg text-slate-400">Powerful features designed to put you back in control of your medical journey, from decoding doctor's notes to managing chronic diseases.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="p-8 rounded-3xl bg-slate-900/50 border border-white/5 hover:border-indigo-500/30 hover:bg-slate-800/50 transition-all duration-300 group">
      ...
      <div className="w-full bg-indigo-900/10 border-t border-white/5 py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Loved by patients and caregivers.</h2>
            <p className="text-slate-400 text-lg">Real stories from people who took control of their healthcare.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-900 border border-white/10 p-8 rounded-3xl relative">
              ...
              <p className="text-slate-300 font-medium mb-8 leading-relaxed text-lg">
                "My grandfather takes 8 different medicines a day. I used to struggle reading his prescriptions. Now, I just take a photo and the AI tells me exactly what each medicine is for and when to give it."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-lg">A</div>
                <div>
            ...
            <div className="bg-slate-900 border border-white/10 p-8 rounded-3xl relative transform md:-translate-y-4">
              ...
              <p className="text-slate-300 font-medium mb-8 leading-relaxed text-lg">
                "I was spending almost ₹4000 a month on my diabetes and hypertension medication. The generic medicine finder showed me identical alternatives that brought my bill down to ₹1200. Life changing."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-pink-500 rounded-full flex items-center justify-center text-white font-bold text-lg">S</div>
                <div>
                  <div className="text-white font-bold">Sneha Patel</div>
                  <div className="text-slate-400 text-sm">Regular Medicine User</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-white/10 p-8 rounded-3xl relative">
              ...
              <p className="text-slate-300 font-medium mb-8 leading-relaxed text-lg">
                "The personalized diet recommendations are amazing. The AI recognized my thyroid medication and automatically gave me a list of foods to avoid and recommended a daily routine. It's like having a digital doctor."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-white font-bold text-lg">R</div>
                <div>
      ...
      <div className="w-full py-32 text-center px-4">
        <h2 className="text-4xl font-bold text-white mb-6">Ready to decode your prescription?</h2>
        <p className="text-slate-400 mb-10 text-lg">Join thousands of users making smarter healthcare decisions today.</p>
        <Link
          to="/register"
